...
INSERT INTO audit_logs (entity_type, entity_id, action, after_state, performed_by, performed_at) VALUES
  ('schedule', 'e0000000-0000-4000-a000-000000000001', 'create',
   '{"location": "Downtown", "week_start": "current_week", "status": "draft"}',
   'd0000000-0000-4000-a000-000000000002', NOW() - INTERVAL '5 days'),
  ('schedule', 'e0000000-0000-4000-a000-000000000001', 'publish',
   '{"location": "Downtown", "status": "published"}',
   'd0000000-0000-4000-a000-000000000002', NOW() - INTERVAL '2 days');
